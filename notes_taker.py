...
choice=int(input())
print("Loading your class, please wait...\n")
...
#print("Selected: \n")
#print out selected sentences list
#for i in sum1:
    #print (i) -> prints sentence number
    #print(sentences2[i]) #prints sentences chosen for summary
